...
<div class="LoginWindow">
	...
	<form action="login.php" method="post">
		<div class="login">
			<p><input type="text" name="useraccount" id="id" placeholder="用户账号" value=""></p>
...
<div class="box">
	<div class="regiest">
		...
		<p><input type="text" id="nickname" name="useraccount" placeholder="<?php echo time()?>" value="<?php echo time()?>"></p>
		...
		<p>
		旅游<input type="radio" name="hobby" value="1">
		吃货<input type="radio" name="hobby" value="2">
		运动<input type="radio" name="hobby" value="3">
		购物<input type="radio" name="hobby" value="4">
		</p>
		<div id="btn2">
			<ul>
...
<p>来源:<a href="http://www.ui3g.com/" target="_blank">优设计(www.ui3g.com)</a></p>
</div>
</body>
</html>